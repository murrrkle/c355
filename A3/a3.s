...
.global main
        ...
        init:   call    random                                          ! Calling random function; storing random integer into %o0
                ...
                sub     %i0,            %l0,                %o1         ! Prepare index for output; filled delay slot
       ...
       inner:   cmp     %l1,            0                               ! Test: is j > 0?
                ...
                sub     %l1,            1,                  %l1         ! Updating j for next iteration; filled delay slot
                
        skip:   add     %l1,            1,                  %l7
                sub     %l1,            %i0,                %l7         ! Calculating offset to find v[j]
                smul    %l7,            4,                  %l7         ! Calculating offset to find v[j]; done

                st      %l6,            [ %fp + %l7 ]                   ! %l7 still stores offset for j. v[j] = tmp
